...
void HVSystemLogin()
{
	...
	con_printf("( SY1527 -> 0,  SY2527 -> 1, SY4527 -> 2, SY5527 -> 3, V65XX -> 4, N14XX -> 5, V8100 -> 6, N568E -> 7, DT55XX - > 8, DT55XXE - > 9, SMARTHV - > A): ");
	c = con_getch();
	while( c != '0' && c != '1' && c != '2' && c != '3' && c != '4' && c != '5' && c != '6' && c != '7' && c != '8' && c != '9'&& c != 'A' )
		c = con_getch();
	if (c == '0') sysType= c - '0';
	if (c == '1') sysType= c - '0';
	if (c == '2') sysType= c - '0';
